...
def main():
    ...
    total_hours = calculate_hours(mon = mon_hours, tues = tues_hours, wed = wed_hours, thurs = thurs_hours, fri = fri_hours)
    ...
    print(f"Tuesday: {tues_hours} hour(s)")
    print(f"Wednesday: {wed_hours} hour(s)")
    print(f"Thursday: {thurs_hours} hour(s)")
    print(f"Friday: {fri_hours} hour(s)")
    print(f"Total Hours: {total_hours} hour(s)")
    print(f"Pay Rate: ${pay_rate}0 per hour")
    print(f"Total Pay: ${total_pay}0")
main()